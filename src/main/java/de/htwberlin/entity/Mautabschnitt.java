...
public class Mautabschnitt {
	...
	/**
	 * die Koordinate wo der Abschnitt geopraphisch anfängt - Latitude and
	 * Longitude
	 **/
	...
	/** liefert die Laenge in Meteren für den Mautabschnitt **/
	public int getLaenge() {
		return laenge;
	}

	/*** setzt die Laenge in Metern für den Mautabschnitt */
